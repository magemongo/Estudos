...
GO
PRINT N'Rename refactoring operation with key 963e4174-4f68-45fd-bbe2-a261cffcc542 is skipped, element [dbo].[Table1].[Id] (SqlSimpleColumn) will not be renamed to Cod_Fabrica';
...
GO
PRINT N'Rename refactoring operation with key e4b53618-f392-40a0-a939-d1435a3a7744 is skipped, element [dbo].[Dim_Tempo].[Id] (SqlSimpleColumn) will not be renamed to Cod_Dia';


GO
PRINT N'Rename refactoring operation with key 732c2f4a-1d43-4ac1-accd-7fd3e6f4999a is skipped, element [dbo].[Dim_Tempo].[Dia_Da_Semana] (SqlSimpleColumn) will not be renamed to Dia_Semana';


GO
PRINT N'Rename refactoring operation with key 4d384d0e-4fe7-4cb6-843d-f96321d3e3d9 is skipped, element [dbo].[Dim_Tempo].[E] (SqlSimpleColumn) will not be renamed to Tipo_Dia';
...
GO
ALTER TABLE [dbo].[Fato_001] WITH NOCHECK
    ADD CONSTRAINT [FK_Fato_001_Dim_Fabricas] FOREIGN KEY ([Cod_Fabrica]) REFERENCES [dbo].[Dim_Fabrica] ([Cod_Fabrica]);
...
GO
ALTER TABLE [dbo].[Fato_002] WITH NOCHECK
    ADD CONSTRAINT [FK_Fato_002_Dim_Fabricas] FOREIGN KEY ([Cod_Fabrica]) REFERENCES [dbo].[Dim_Fabrica] ([Cod_Fabrica]);
...
ALTER TABLE [dbo].[Fato_003] WITH NOCHECK
    ADD CONSTRAINT [FK_Fato_003_Dim_Fabricas] FOREIGN KEY ([Cod_Fabrica]) REFERENCES [dbo].[Dim_Fabrica] ([Cod_Fabrica]);
...
GO
ALTER TABLE [dbo].[Fato_005] WITH NOCHECK
    ADD CONSTRAINT [FK_Fato_005_Dim_Fabricas] FOREIGN KEY ([Cod_Fabrica]) REFERENCES [dbo].[Dim_Fabrica] ([Cod_Fabrica]);
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '963e4174-4f68-45fd-bbe2-a261cffcc542')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('963e4174-4f68-45fd-bbe2-a261cffcc542')
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'e4b53618-f392-40a0-a939-d1435a3a7744')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('e4b53618-f392-40a0-a939-d1435a3a7744')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '732c2f4a-1d43-4ac1-accd-7fd3e6f4999a')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('732c2f4a-1d43-4ac1-accd-7fd3e6f4999a')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '4d384d0e-4fe7-4cb6-843d-f96321d3e3d9')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('4d384d0e-4fe7-4cb6-843d-f96321d3e3d9')
